...
public abstract class MangleGameIO implements Mangle
{
	...
	private final String readInput()
	{
		try
		{
			System.out.print(promptString); // prompt user
			String input = console.readLine(); // possible exception
			// test for end of file or blank line
